...
| `WHATSAPP_BOT_URL_MINIMES` | Bot campagne Minimes (compta-boxing : port 21334) — aussi utilisé par **phone-bot** (bot téléphonique 09 39 03 67 48) pour les WhatsApp aux appelants |
