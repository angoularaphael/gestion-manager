      ...
      <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;">
        <tr>
          <td width="80" valign="middle" style="padding-right:14px;">
            <img src="${logo}" alt="Boxing Center" width="64" height="64" style="display:block;width:64px;height:64px;border-radius:10px;background:#ffffff;padding:5px;object-fit:contain;" />
          </td>
