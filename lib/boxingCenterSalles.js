/** 5 salles Boxing Center + Balma (cession, filtre import / fiches) */
...
const SALLE_ALIASES = {
  ...
  balma: ['balma', 'balma gramont', 'boxing center balma'],
};
...
export function isBalmaSalle(value) {
  return matchClientSalle(value, 'balma');
}
