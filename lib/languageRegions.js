...
export const BOXING_CENTER_REPLY_EMAIL = 'boxingcenter31@gmail.com';

export const JOHNSON_SUFFO_SUBJECTS = {
  fr: 'Recherche adversaire sur gala externe — Johnson SUFFO (70–73 kg)',
  en: 'Seeking opponent for external show — Johnson SUFFO (70–73 kg)',
  es: 'Búsqueda de rival en gala externo — Johnson SUFFO (70–73 kg)',
};

export const JOHNSON_SUFFO_MESSAGES = {
  fr: `Bonjour,

Le Boxing Center ne monte pas de gala et n'organise pas d'événement : nous recherchons une opportunité de combat à l'extérieur pour notre boxeur Johnson SUFFO, afin qu'il puisse boxer sur un gala organisé par un autre promoteur ou club.
...
Si vous organisez un gala ou recherchez un adversaire dans cette catégorie, merci de répondre directement par email au Boxing Center :
${BOXING_CENTER_REPLY_EMAIL}
...
Boxing Center is not promoting a show and is not the event organizer: we are looking for an external fight opportunity for our boxer Johnson SUFFO, so he can compete on a gala promoted by another promoter or club.
...
If you are promoting a show or looking for an opponent in this weight class, please reply directly by email to Boxing Center:
${BOXING_CENTER_REPLY_EMAIL}
...
Boxing Center no organiza un gala ni es el promotor del evento: buscamos una oportunidad de combate externa para nuestro boxeador Johnson SUFFO, para que pueda boxear en un evento organizado por otro promotor o club.
...
Si organiza un gala o busca un rival en esta categoría, responda directamente por email a Boxing Center:
${BOXING_CENTER_REPLY_EMAIL}
