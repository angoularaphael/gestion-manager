...
async function sendViaRestApi({ to, subject, html, text, replyTo, replyToName, customHeaders }) {
...
export async function sendEmailViaBrevo({
  ...
  if (apiKeyConfigured()) {
    return sendViaRestApi({ to, subject, html, text, replyTo, replyToName, customHeaders });
  }
