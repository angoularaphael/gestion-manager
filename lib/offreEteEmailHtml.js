  ...
  <tr>
    <td align="center" style="padding:0 0 12px;">
      <a href="${shop}" target="_blank" rel="noopener noreferrer" style="text-decoration:none;">
        <img src="${hero}" alt="Offre ete 2026 Boxing Center - 3 mois illimites 89 euros"
             width="520"
             style="display:block;width:520px;max-width:100%;border:0;outline:none;text-decoration:none;margin:0 auto;" />
      </a>
    </td>
  </tr>
  <tr>
...
export function buildOffreEteEmailBodyHtml(body, { heroSrc } = {}) {
  ...
  const htmlLines = lines
    .map((line) => {
      ...
      if (/OFFRE LIMITEE/i.test(line)) {
        return `<strong style="color:#E30613;font-size:17px;letter-spacing:0.02em;">${esc}</strong>`;
      }
      return esc;
    })
    .join('<br>\n');
...
<table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin:0 0 16px;border-collapse:collapse;">
  <tr>
    <td style="padding:14px 16px;background:#f0fdf4;border:1px solid #86efac;border-radius:10px;font-family:Arial,Helvetica,sans-serif;font-size:14px;line-height:1.6;color:#14532d;">
      ...
      • 1 t-shirt offert — <strong>inclus, à récupérer dans la salle de ton choix</strong>
    </td>
  </tr>
</table>
