export const ADMIN_NAV = [
  ...
  },
  {
    ...
    sectionClass: 'contacts',
    accent: 'blue',
    links: [{ href: '/admin/documents', text: 'Devis / Factures', icon: 'file' }],
  },
  {
    label: 'Marketing',
    sectionClass: 'contacts',
    accent: 'gold',
    links: [
      { href: '/admin/com-balma', text: 'Com Balma', icon: 'megaphone', featured: true },
      { href: '/admin/com-offres', text: 'Offres promo', icon: 'megaphone', featured: true },
      { href: '/admin/campagne-planning', text: 'Planning campagne', icon: 'megaphone' },
      { href: '/admin/campagne-whatsapp', text: 'Bots WhatsApp campagne', icon: 'chat' },
      { href: '/admin/campagne-wa-envoyes', text: 'WA déjà envoyés', icon: 'chat' },
...
export const PAGE_TITLES = {
  ...
  '/admin/com-balma': 'Com Balma',
  '/admin/com-offres': 'Offres promo',
  '/admin/campagne-planning': 'Planning campagne',
  '/admin/campagne-whatsapp': 'Campagne WhatsApp',
  '/admin/campagne-wa-envoyes': 'WA déjà envoyés',
  '/admin/chatbot': 'Chatbot Portet',
  '/admin/clients': 'Clients',
  '/admin/envoyer-clients': 'Envoyer clients',
  '/admin/documents': 'Devis / Factures',
};
