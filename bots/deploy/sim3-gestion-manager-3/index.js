...
process.env.BOT_INSTANCE_ID = process.env.BOT_INSTANCE_ID || 'sim3';
process.env.SERVER_PORT = process.env.SERVER_PORT || process.env.PORT || '20695';
console.log('=== CAMPAGNE BALMA — gestion-manager-3 (sim3) ===');
