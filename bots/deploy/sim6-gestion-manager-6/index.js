...
process.env.BOT_INSTANCE_ID = process.env.BOT_INSTANCE_ID || 'sim6';
process.env.SERVER_PORT = process.env.SERVER_PORT || process.env.PORT || '21724';
console.log('=== CAMPAGNE BALMA — gestion-manager-6 (sim6) ===');
