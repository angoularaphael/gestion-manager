...
process.env.BOT_INSTANCE_ID = process.env.BOT_INSTANCE_ID || 'sim5';
process.env.SERVER_PORT = process.env.SERVER_PORT || process.env.PORT || '21871';
console.log('=== CAMPAGNE BALMA — gestion-manager-5 (sim5) ===');
