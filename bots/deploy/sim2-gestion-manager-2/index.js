...
process.env.BOT_INSTANCE_ID = process.env.BOT_INSTANCE_ID || 'sim2';
process.env.SERVER_PORT = process.env.SERVER_PORT || process.env.PORT || '20405';
console.log('=== CAMPAGNE BALMA — gestion-manager-2 (sim2) ===');
