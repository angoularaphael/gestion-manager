...
process.env.BOT_INSTANCE_ID = process.env.BOT_INSTANCE_ID || 'sim1';
process.env.SERVER_PORT = process.env.SERVER_PORT || process.env.PORT || '21357';
console.log('=== CAMPAGNE BALMA — gestion-manager-1 (sim1) ===');
